      ...
      <div className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-white shadow-lg transition-all duration-300`}>
        <div className="p-4 border-b">
          <div className="flex items-center justify-between">
            <h2 className={`font-bold text-xl text-gray-800 ${!sidebarOpen && 'hidden'}`}>Admin Panel</h2>
            <button
          ...
          {menuItems.map((item) => (
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg mb-2 transition-colors ${
                activeSection === item.id || (activeSection === 'employee-attendance' && item.id === 'employees')
